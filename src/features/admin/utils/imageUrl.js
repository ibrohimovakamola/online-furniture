...
/**
 * Resolve product/category image paths for the admin UI.
 * Prefer same-origin /uploads (Vite proxies to the Express server).
 */
...
/** Pick the best image source from an admin product payload */
